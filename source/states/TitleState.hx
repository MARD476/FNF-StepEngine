...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		switch(easterEgg.toUpperCase())
		{
			...
			//EDIT THIS ONE IF YOU'RE MAKING A SOURCE CODE MOD!!!!
				...
				gfDance.animation.addByPrefix('danceLeft', 'gfDance', 14, true);
	...
	override function update(elapsed:Float)
	{
		...
		if (FlxG.keys.justPressed.CONTROL || FlxG.keys.justPressed.ESCAPE)
		{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				case 1:
					...
					createCoolText(['Step Engine by'], 45);
				case 2:
					addMoreText('MARD', 45);
				case 3:
				    addMoreText('Just me lol', 50);
				case 4:
					deleteCoolText();
				case 6:
					#if PSYCH_WATERMARKS
