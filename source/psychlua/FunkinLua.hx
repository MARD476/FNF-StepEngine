...
class FunkinLua {
	...
	public function new(scriptName:String) {
		...
		set('windowsModding', ClientPrefs.data.windowsModding);
		...
		// others
		Lua_helper.add_callback(lua, "popupWindowOpponent", function(widths:Int, heights:Int, name:String) {
			game.popupWindowOpponent(widths, heights, name);
			return true;
		});

		Lua_helper.add_callback(lua, "changePositionOpp", function(customX:Int, customY:Int, insta:Float) {
            game.customXOpp = customX;
			game.customYOpp = customY;
			game.instaTween = insta;
		});

		Lua_helper.add_callback(lua, "changePositionPla", function(customX:Int, customY:Int, insta:Float) {
            game.customXPla = customX;
			game.customYPla = customY;
			game.instaTween = insta;
		});

		Lua_helper.add_callback(lua, "closeWindowOpp", function() {
            if (PlayState.opponentWindow != null) PlayState.closePopupWindowOpp();
		});

		Lua_helper.add_callback(lua, "closeWindowPla", function() {
            if (PlayState.playerWindow != null) PlayState.closePopupWindowPla();
		});	

		Lua_helper.add_callback(lua, "WindowMinimizedOpp", function(minimized:Bool = false) {
            if (PlayState.opponentWindow != null) PlayState.opponentWindow.minimized = minimized;
		});		

		Lua_helper.add_callback(lua, "WindowMinimizedPla", function(minimized:Bool = false) {
            if (PlayState.playerWindow != null) PlayState.playerWindow.minimized = minimized;
		});		

		Lua_helper.add_callback(lua, "popupWindowPlayer", function(widths:Int, heights:Int, name:String) {
			game.popupWindowPlayer(widths, heights, name);
			return true;
		});			
		...
		Lua_helper.add_callback(lua, "posePositionGOD", function(xi:Int, yi:Int, xl:Int, yl:Int, xd:Int, yd:Int, xu:Int, yu:Int, xr:Int, yr:Int) {
            game.gifXI = xi; 
			game.gifYI = yi; 
		...
		Lua_helper.add_callback(lua, "posePositionGODBF", function(xi:Int, yi:Int, xl:Int, yl:Int, xd:Int, yd:Int, xu:Int, yu:Int, xr:Int, yr:Int) {
            game.gifXIB = xi; 
			game.gifYIB = yi; 
		...
		Lua_helper.add_callback(lua, "posePositionGODGF", function(xi:Int, yi:Int, xl:Int, yl:Int, xd:Int, yd:Int, xu:Int, yu:Int, xr:Int, yr:Int) {
            game.gifXIG = xi; 
			game.gifYIG = yi; 
